...
public:
	...
	void NetMulticastHealthChanged(AActor* Instigatorctor, float NewRage, float Delta);
	...
	UFUNCTION(NetMulticast, Reliable)
	void NetMulticastRageChanged(AActor* Instigatorctor, float NewRage, float Delta);
